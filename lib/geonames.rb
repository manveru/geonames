...
module GeoNames
  ...
  def register(name, *keys)
    joined = keys.flatten.uniq.sort.join(',')
    APIS[name] = Addressable::Template.new(
  ...
  def query(name, parameters)
    ...
    uri = APIS[name].expand(default.merge(parameters))
  ...
  register(:earthquakes,
    %w[north south east west date callback minMagnitude maxRows]
  )
  ...
  register(:children, :geonameId, :maxRows)
  ...
  register(:cities, %w[north south east west callback lang maxRows])
  ...
  register(:weather, %w[north south east west callbck maxRows])
  ...
  register(:weatherIcao, :ICAO, :callback)
  ...
  register(:countryInfo, %w[country lang])
  ...
  register(:countryCode, %w[lat lng type lang radius])
  ...
  register(:countrySubdivision, %w[lat lng lang radius])
  ...
  register(:neighbourhood, %w[lat lng])
  ...
  register(:timezone, %w[lat lng radius])
  ...
  register(:findNearby,
    %w[lat lng featureClass featureCode radius maxRows style]
  )
  ...
  register(:findNearbyPlaceName, %w[lat lng radius maxRows style])
  ...
  register(:findNearbyPostalCodes, %w[lat lng radius maxRows style country
    localCountry postalcode country radius]
  )
  ...
  register(:findNearbyStreets, %w[lat lng])
  ...
  register(:findNearbyStreetsOSM, %w[lat lng])
  ...
  register(:findNearByWeather, %w[lat lng])
  ...
  register(:findNearbyWikipedia, %w[lang lat lng maxRows country postalcode country radius])
  ...
  register(:findNearestAddress, %w[lat lng])
  ...
  register(:findNearestIntersection, %w[lat lng])
  ...
  register(:findNearestIntersectionOSM, %w[lat lng])
  ...
  register(:postalCodeCountryInfo)
  ...
  register(:postalCodeLookup, %w[postalcode country maxRows, callback charset])
  ...
  register(:postalCodeSearch,
    %w[postalcode postalcode_starts placename placename_starts country
      countryBias maxRows style operator charset isReduced]
  )
  ...
  register(:search,
    %w[q name name_equals name_startsWith maxRows startRow country countryBias
  ...
  register(:wikipediaBoundingBox, %w[south north east west lang maxRows])
  ...
  register(:wikipediaSearch, %w[q title lang maxRows])
end
